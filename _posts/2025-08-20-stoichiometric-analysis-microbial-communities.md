...
# Optional banner (add an image at assets/img/posts/stoich-communities.jpg and uncomment below):
# header:
#   overlay_color: "#000000"
#   overlay_filter: "0.12"
#   overlay_image: "{{ '/assets/img/posts/stoich-communities.jpg' | relative_url }}"
classes: wide
---

Excited to share our new preprint: **"Stoichiometric analysis of microbial communities: interrelating community function, structure and biomass carrying capacity"** (Bruggeman FJ, Paez-Watson T, Teusink B, Kleerebezem R; 2025). :contentReference[oaicite:0]{index=0}
